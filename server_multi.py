...
def register(user_message):
    ...
    contact_name = user_message.get("contact_name")
...
def log_in(user_message):
    ...
    if logged_in_username:
        ...
        # return f"{logged_in_username}is connected"

        return "True" # return true because user connected successfully
    else:
...
def handle_client(client_socket, client_address):
    ...
    try:
        ...
        if type == "REGISTER":
            ...
            new_chat_id = firebase_chat.save_chat_history(["user1"], message.get("text"))
